...
class SettingsTests(unittest.TestCase):
    ...
    def test_defaults_favor_family_routing_and_iterative_retrieval_budgets(self) -> None:
        ...
        # Raising this to 150s was tried and reverted: a request that would have failed
        # at 90 spends 150 before succeeding, and the run has a thirty-minute wall clock.
        # The repair for a timeout is a cheaper retry, not a longer wait.
