...
# The contract costs something. Measured against the version without it, English was a dead
# tie overall while gaining 0.070 of context awareness, and non-English lost 0.069 — the
# structured constraint compresses an answer, and it compresses a non-English answer
# harder. The wall it was built to break is English-only anyway: the model already ends
# Korean answers with a question when the prompt asks it to. So the contract is applied
