...
4. Read [references/l2-usage-guide.md](references/l2-usage-guide.md) before designing or changing L2 prompts, retrieval/generation orchestration, MCP exposure, citations, or multi-turn handling.
5. Read [references/api-and-patient-simulator.md](references/api-and-patient-simulator.md) before implementing L2 API calls, authentication, environment configuration, Patient Simulator tests, or retry behavior.
6. Read [references/mcp-tool-guide.md](references/mcp-tool-guide.md) before configuring MCP, selecting retrieval tools or data sources, implementing the MCP client, or changing retrieval routing.
7. Read [references/submission-spec.md](references/submission-spec.md) before changing the service boundary, API behavior, Docker setup, branch strategy, evaluation flow, or submission process.
8. Re-read all seven references before claiming the project is ready for evaluation or final submission.
...
- Prefer evaluator compatibility and a reliable end-to-end path over optional scope, especially within the 20-hour timebox.
